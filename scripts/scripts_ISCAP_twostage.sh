...
#SBATCH -o /leonardo_work/IscrC_Fed-GCD/hyzheng/debug_fedgcd/DPC2L/hyzheng/log_twostage/twostage_cub_seed0_lr01_epoch200_memax1.log

module load cuda/12.1
source /leonardo/home/userexternal/hzheng00/miniconda3/bin/activate fedgcd

CUDA_VISIBLE_DEVICES=0 python 16.ISCAP_full_twostage.py \
 --dataset_name='cub' \
 --single_minsim_1=0.6 \
 --single_minsim_2=0.6 \
 --single_minsim_3=0.6 \
 ...
 --seed=0 \
 --lr=0.1 \
 --exp_name='twostage_cub_seed0_lr01_epoch200_memax1' \