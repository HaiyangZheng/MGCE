...
#SBATCH -o /leonardo_work/IscrC_Fed-GCD/hyzheng/debug_fedgcd/DPC2L/hyzheng/log_full/scars_dccl_threehead_k1(15-0.6)_alignloss(0.1)_dcclloss(0.3)_replication.log

module load cuda/12.1
source /leonardo/home/userexternal/hzheng00/miniconda3/bin/activate fedgcd

CUDA_VISIBLE_DEVICES=0 python 5.ISCAP_DCCL_alignloss_base_multilevel_tosimgcd_otherdatasets.py \
 --dataset_name='scars' \
 --single_minsim_1=0.6 \
 --single_minsim_2=0.6 \
 --single_minsim_3=0.6 \
 ...
 --exp_name='scars_dccl_threehead_k1(15-0.6)_alignloss(0.1)_dcclloss(0.3)_replication' \