...
from config_iscap import exp_root, cub_root, cars_root, pets_root, osr_split_dir, dino_pretrain_path, cub_model_best, cifar_100_root, aircraft_root, herbarium_dataroot
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                ...
                for i_, (name, projector) in enumerate(projector_dict.items()):
                    ...
                    if "target" in name:
                        ...
                        loss += args.sup_weight * target_cls_loss
                    ...
                    if args.use_contrastive_cluster and "target" not in name:
                        ...
                        if name == 'DCCL2' or name == 'DCCL3':
                            ...
                            DCCL_align_loss = align_loss_to_simgcd_soft(DCCL_f_out,dccl_centers,base_centers, base_output)
