...
def get_imagenet_100_datasets(train_transform, test_transform, train_classes=range(80),
    ...
    imagenet_training_set = ImageNetBase(root=os.path.join(args.imagenet_root, 'train'), transform=train_transform)
    ...
    test_dataset = ImageNetBase(root=os.path.join(args.imagenet_root, 'val'), transform=test_transform)
...
def get_imagenet_1k_datasets(train_transform, test_transform, train_classes=range(500),
    ...
    # Init entire training set
    whole_training_set = ImageNetBase(root=os.path.join(args.imagenet_root, 'train'), transform=train_transform)
