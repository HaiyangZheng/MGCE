...
class FGVCAircraft(Dataset):
    ...
    def __init__(self, root, class_type='variant', split='train', transform=None,
        ...
        self.split = split
        self.classes_file = os.path.join(self.root,
...
def get_aircraft_datasets(train_transform, test_transform, train_classes=range(50), prop_train_labels=0.8,
    ...
    whole_training_set = FGVCAircraft(root=args.aircraft_root, transform=train_transform, split='trainval')
    ...
    test_dataset = FGVCAircraft(root=args.aircraft_root, transform=test_transform, split='test')
...
if __name__ == '__main__':
    ...
    args.aircraft_root = '/leonardo_work/IscrC_DiffGRE/Datasets/fgvc_aircraft'

    x = get_aircraft_datasets(None, None, split_train_val=False, args=args)
