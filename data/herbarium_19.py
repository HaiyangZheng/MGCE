...
herbarium_dataroot='/leonardo_work/IscrC_Fed-GCD/GCD_datasets/herbarium_19'
osr_split_dir = '/leonardo_work/IscrC_Fed-GCD/hyzheng/debug_fedgcd/data/ssb_splits'
...
def get_herbarium_datasets(train_transform, test_transform, train_classes=range(500), prop_train_labels=0.8,
                            seed=0, split_train_val=False, federated_args=None):
