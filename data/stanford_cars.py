...
class CarsDataset(Dataset):
    """
        Cars Dataset
    """
    def __init__(self, train=True, limit=0, data_dir=None, transform=None):
...
def get_scars_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    whole_training_set = CarsDataset(data_dir=args.cars_root, transform=train_transform, train=True)
    ...
    test_dataset = CarsDataset(data_dir=args.cars_root, transform=test_transform, train=False)
