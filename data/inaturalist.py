...
class INaturalist_SUB(INaturalist):
    def __init__(self, root, version='2017', subclassname='', transform=None, target_transform=None, download=False):
        ...
        ### add by haiyang for dccl
        self.targets = []
        self.data = []
        for i in range(len(self)):
            cat_id, fname = self.index[i]
            self.targets.append(cat_id)
            img_path = os.path.join(self.root, self.all_categories[self.reverse_index_map[cat_id]], fname)
...
def get_inaturalist_datasets(train_transform, 
    ...
    whole_training_set = INaturalist_SUB(root=args.inaturalist_root, subclassname=subclassname, transform=train_transform)
    ...
    whole_test_dataset = INaturalist_SUB(root=args.inaturalist_root, subclassname=subclassname, transform=test_transform)
...
if __name__ == '__main__':
    ...
    # args.inaturalist_root = '/scratch-shared/npu/GCD_datasets/iNaturalist'
    args.inaturalist_root = '/local/hek/GCD_datasets/iNaturalist'


    print("------------------Amphibia-----------------")
    x = get_inaturalist_datasets(None, None, subclassname='Amphibia', split_train_val=False,
                         train_classes=range(58), prop_train_labels=0.5, args=args)
    ...
    x = get_inaturalist_datasets(None, None, subclassname='Animalia', split_train_val=False,
                         train_classes=range(39), prop_train_labels=0.5, args=args)
    ...
    x = get_inaturalist_datasets(None, None, subclassname='Arachnida', split_train_val=False,
                         train_classes=range(28), prop_train_labels=0.5, args=args)
    ...
    x = get_inaturalist_datasets(None, None, subclassname='Fungi', split_train_val=False,
                         train_classes=range(61), prop_train_labels=0.5, args=args)
    ...
    x = get_inaturalist_datasets(None, None, subclassname='Mammalia', split_train_val=False,
                         train_classes=range(93), prop_train_labels=0.5, args=args)
    ...
    x = get_inaturalist_datasets(None, None, subclassname='Mollusca', split_train_val=False,
                         train_classes=range(47), prop_train_labels=0.5, args=args)
    ...
    x = get_inaturalist_datasets(None, None, subclassname='Reptilia', split_train_val=False,
                         train_classes=range(145), prop_train_labels=0.5, args=args)
