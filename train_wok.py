...
def extract_features_with_headlist(backbone, project_dict, data_loader, args):
    ...
    for _item in data_loader:
        ...
        cls_token = backbone(imgs, False) # [batch_size, feat_dim]
...
def DCCL(cluster_dataset, cluster_loader, model, projector_dict, epoch, args):
    ...
    for name in dccl_names:
        ...
        # ===== (Rest) 构建 memory、伪标签数据集、评估、采样器、loader =====
    ...
    for epoch in range(args.epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.cuda.amp.autocast(fp16_scaler is not None):
                ...
                simgcd_cls_loss, _, simgcd_contrastive_loss, simgcd_sup_con_loss = simgcd_loss(
                ...
                total_loss += args.sup_weight * simgcd_cls_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument('--token_cache_dir', type=str, default='/leonardo_work/IscrC_DiffGRE/MGCE_release/temp/token_cache')
